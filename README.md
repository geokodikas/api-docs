# Geokodikas OpenAPI Specification
...
- [Reference Documentation (ReDoc)](https://geokodikas.github.io/api-docs/)
- OpenAPI Raw Files: [JSON](https://geokodikas.github.io/api-docs/openapi.json) [YAML](https://geokodikas.github.io/api-docs/openapi.yaml)
